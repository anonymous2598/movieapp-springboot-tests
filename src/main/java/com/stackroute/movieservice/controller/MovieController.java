...
public class MovieController {
   ...
   private ResponseEntity responseEntity;
    ...
    @PostMapping("movie")
    public ResponseEntity<?> saveMovieInfo(@RequestBody MovieInfo movieInfo) throws MovieAlreadyExists {
    ...
    @DeleteMapping("movie")
    public ResponseEntity<?> deleteMovieInfo(@RequestBody Long repoId) throws MovieDoesNotExist {
    ...
    @PutMapping("movie")
    public ResponseEntity<?> updateMovie(@RequestBody MovieInfo movieInfo) throws MovieDoesNotExist
    {
    ...
    @GetMapping("a")
    public ResponseEntity<?> getMovieByName(@RequestBody String movieName) throws MovieDoesNotExist {
        List<MovieInfo> list;
